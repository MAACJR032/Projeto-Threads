...
pthread_cond_t emptyConditional = PTHREAD_COND_INITIALIZER;//condicional para fazer a thread do escalonador dormir quando n tem thread na lista e acorda quando uma for inserida
pthread_cond_t fullConditional = PTHREAD_COND_INITIALIZER;//condicional para fazer a thread do escalonador dormir quando n tem thread na lista e acorda quando uma for inserida
